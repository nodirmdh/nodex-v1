  ...
  return (
    <ClientShell active="trips">
      ...
      <Card className="mt-5 space-y-4">
        ...
        <h1 className="m-0 text-2xl font-black">Используйте актуальный экран деталей поездки</h1>
        <p className="m-0 text-sm font-semibold text-[rgb(var(--text-muted))]">
          This route remains available for smoke coverage. Product navigation uses Trips and Trip
          details instead.
        </p>
        <div aria-label="Линия маршрута" className="grid gap-3">
          <h2 className="m-0 text-lg font-black">Линия маршрута</h2>
          {[
            ["Nukus Central Station", "08:30"],
            ["Остановка для отдыха", "10:00"],
