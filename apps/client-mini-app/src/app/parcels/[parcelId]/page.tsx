...
import { AppHeader, Badge, BottomNav, Panel, Timeline, formatUzs } from "@nodex/ui";
    ...
    <main className="nodex-app mobile-shell">
      ...
      <div className="space-y-4 px-4 pb-24">
        <Panel className="space-y-3" aria-label="Детали посылки">
          ...
          <div className="grid grid-cols-2 gap-2 text-sm"><Info label="Водитель" value="Madina Yusupova" /><Info label="Машина" value="Chevrolet Tracker" /><Info label="Получатель" value="Bekzod Ergashev" /><Info label="Прибытие" value="19:45" /><Info label="Размер" value="Маленькая · документы" /><Info label="Цена" value={formatUzs(3200000)} /></div>
