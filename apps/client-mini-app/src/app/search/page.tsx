...
export default function SearchPage() {
  ...
  return (
    <ClientShell active="trips">
      ...
      <RequestLifecycle stage={matchStage} onStage={setMatchStage} />
...
function RequestLifecycle({ stage, onStage }: { stage: MatchStage; onStage: (stage: MatchStage) => void }) {
