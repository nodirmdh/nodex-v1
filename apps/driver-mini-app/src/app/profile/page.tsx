...
export default function DriverProfile() {
  return (
    <DriverShell active="profile">
      ...
      <Group title="Автомобиль и документы"><Row href="/vehicles" title="Автомобиль" subtitle="Chevrolet Cobalt · одобрен" /><Row href="/verification" title="Документы" subtitle="Проверка водителя и машины" /><Row href="/subscription" title="Подписка" subtitle="Бесплатный период · осталось 72 дня" /></Group>
